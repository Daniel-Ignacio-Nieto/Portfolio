...
import PWA from "../Assets/Iconos/PWA.png";
import RXJS from "../Assets/Iconos/Rxjs.png";
import NGRX from "../Assets/Iconos/NgRx.png";
import SASS from "../Assets/Iconos/SASS.png";
		...
		<>
			<div className="Skills-Container">
				<Flip left>
					...
					<div className="Skills-Card">
						<img src={SASS} alt="CSS3" class="" height="100" width="100" />
						<p class="">SASS</p>
					</div>
					<div className="Skills-Card">
					...
					<div className="Skills-Card">
						<img src={ANGULAR} alt="React" class="" height="100" width="100" />
						<p class="">Angular</p>
					</div>
					<div className="Skills-Card">
					...
					<div className="Skills-Card">
						<img src={NGRX} alt="Redux" class="" height="100" width="100" />
						<p class="">NgRx</p>
					</div>
					<div className="Skills-Card">
						<img src={RXJS} alt="Redux" class="" height="100" width="100" />
						<p class="">RxJS</p>
					</div>
					<div className="Skills-Card">
					...
					<div className="Skills-Card">
						<img src={PWA} alt="Passport" class="" height="100" width="100" />
						<p class="">PWA</p>
					</div>
					<div className="Skills-Card">
